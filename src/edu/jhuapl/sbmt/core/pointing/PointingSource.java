...
public enum PointingSource
{
    ...
    private PointingSource(String nameString, String databaseTableName, String pointingDir, String pointingType)
    {
    ...
    public static String printSources(int tabLen)
    {
        ...
        PointingSource[] sources = PointingSource.values();
        for (PointingSource s : sources)
        {
            out = out + tab + s.name() + "\n";
        }
        return out;
    ...
    public static PointingSource valueFor(String description)
    {
        for (PointingSource source : values())
        {
