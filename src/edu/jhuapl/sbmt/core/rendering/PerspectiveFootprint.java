...
//  private PerspectiveImageFrustum frustum;
	...
	PerspectiveFootprint(PerspectiveImage image)
	{
	...
	public PerspectiveFootprint()
	{
		this(1, 0, 0, 0.00001);
	}

	public PerspectiveFootprint(int numSlices, int currentSlice, int defaultSlice, double imageOffset)
	{
	...
	PerspectiveFootprint(PerspectiveFrustum frustum, SmallBodyModel smallBodyModel, int numSlices,
        ...
        for (int i=0; i<IMAGE_HEIGHT; ++i)
        {
            ...
            for (int j=0; j<IMAGE_WIDTH; ++j)
            {
                ...
                if (result > 0)
                {
                    ...
                    points.InsertNextPoint(closestPoint[0], closestPoint[1], closestPoint[2]);
